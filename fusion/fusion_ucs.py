...
parser.add_argument('--root_path', type=str, default='/media/public/yan1/doublez/realdoubleZ/Data/MVS/CVP-MVSNet/dtu-test-1200')
...
def load_data(root_path, depth_path, scene_name, thresh):
    ...
    for view in range(49):
        img_filename = "{}/Rectified/{}/rect_{:03d}_3_r5000.png".format(root_path, scene_name, view+1)
        cam_filename = "{}/Cameras/{:08d}_cam.txt".format(root_path, view)
...
if __name__ == '__main__':
 ...
 #                   "/media/public/yan1/doublez/realdoubleZ/Data/MVS/evaluation/",
#                   os.path.join("../../", args.ply_path), 
#                    os.path.join("../../", args.quan_path),
#                    "mvsnet", ply_id
#                )
 #               os.system(command)
 #               print(">>>>>>>> start matlab quantitative for scan{}".format(ply_id))
